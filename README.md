...
> 2026-09-12：当前源码 **0.5.3**，修正 Air724UG 的 5ms tick 换算和延迟心跳回执。真实板上 **0.5.2** 已通过 4G/TLS/WSS 认证与远程 STOP 回执，但因旧计时错误约75秒断线，尚未稳定。0.5.3 完整9项下载包已准备、130项Lua和39项后端测试通过，**尚未刷入验证**。现场结果见 [联调记录](docs/verification-20260912.md)，现行步骤见 [Web 与 4G 接入](docs/web-console.md)；下文0.3.0为控制器基础说明。
