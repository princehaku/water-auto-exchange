...
> 2026-09-14：新增 **一键换水**，先冲水到估算0%，确认关闭并等待2秒后补水到100%；服务器分轮执行，关闭网页后继续，运行时可点击“停止换水”。按钮位于“按目标水位”左边，手机上整行放在手动开关上方。需要可信水位校准，生产固件保持 **0.8.2**，无需刷板。
>
> 手动补水、冲水仍按该路完整100%校准时长运行，两路可同时运行，再点对应开关结束该路作业。补水每轮最多170秒、排水每轮最多290秒，确认关闭后间隔2秒续轮；断联或停止后不会自动续开。“按目标水位”继续保留，三种作业互斥。
