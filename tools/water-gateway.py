...
def parse_status(line):
    ...
    if result.get('project') != 'water_auto_exchange' or result.get('version') not in ('0.3.0', '0.4.0', '0.5.0', '0.5.1', '0.5.2', '0.5.3', '0.6.0', '0.7.0'):
...
def execute(controller, item, ttl_ms, elapsed):
    ...
    try:
        ...
        if command == 'DRAIN' and status.get('version') not in ('0.6.0', '0.7.0'):
