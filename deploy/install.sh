...
for name in aquarium-motion.js aquarium-scene.js aquarium.js aquarium.css aquarium.html index.html health.json; do install -m 644 "deploy/www/$name" "$root/www/water/$name"; done
