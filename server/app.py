...
def validate_status(value):
    ...
    if value.get('project') != 'water_auto_exchange' or value.get('version') not in ('0.3.0', '0.4.0', '0.5.0', '0.5.1', '0.5.2', '0.5.3', '0.6.0', '0.7.0', '0.7.1', '0.7.2'):
    ...
    if result['version'] in ('0.7.0', '0.7.1', '0.7.2'):
...
class Store:
    ...
    def enqueue(self, command, request_id):
        ...
        with self.lock:
            ...
            s = self.status
            if command == 'DRAIN' and s['version'] not in ('0.6.0', '0.7.0', '0.7.1', '0.7.2'):
