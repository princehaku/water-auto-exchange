...
> 2026-09-12：当前源码 **0.6.0**，网页提供独立“补水/FILL”和“冲水/DRAIN”按钮，完整换水START保留在折叠入口。已通过138项Lua、42项后端及隔离浏览器联调。真实板端 **0.5.3** 已由COM4确认，SIM已识别但仍等待移动网络；0.6.0完整9项下载包已准备、尚未刷入。现行步骤见 [Web与4G接入](docs/web-console.md)，历史实证见 [联调记录](docs/verification-20260912.md)。
