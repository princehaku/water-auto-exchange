...
> 2026-09-12：当前源码 **0.5.2**，增加 GPIO12 网络灯与联网阶段日志。COM4 最新实读板上仍是 **0.3.0**，尚无 4G 功能；需使用 `build/firmware/flash-files.txt` 的 9 项生成包，由用户下载后验证。服务器 WSS 与设备凭据 probe 已通过，不能当作板子已联网。现行联网说明见 [Web 与 4G 接入](docs/web-console.md)；下文 0.3.0 为控制器基础说明。
