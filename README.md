...
> 2026-09-12：当前源码 **0.7.0**，提供“补水”和“冲水”手动开关：点击开启，再点关闭，无需水位传感器。默认manual模式，仅需确认输出映射；GPIO仍未填写/禁用。已通过142项Lua、45项后端及本地浏览器联调。本阶段按用户要求不做水流验证。9项下载包已准备，最近实板版本仍0.5.3；步骤见 [Web与4G接入](docs/web-console.md)。
